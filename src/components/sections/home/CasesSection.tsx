...
// TODO: original project uses this fancy particle background
// but it implies turning it into a client component - might not be worth it
// see implementation with up to date package in https://www.npmjs.com/package/react-tsparticles
...
const CasesSection = () => (
  <section>
    <div className={tw(`w-full min-h-screen bg-gray-900 relative`)}>
      <div
        className={tw(`absolute left-0 top-0 h-screen w-full overflow-hidden`)}
      >
        {/* <ParticleBg /> */}
      </div>
          ...
          <div className={tw(`w-full flex flex-wrap justify-around`)}>
            ...
            >
              ...
              <Image
                ...
                width={24}
                height={24}
                className={tw(`h-6 w-6 fill-current ml-2`)}
              />
            </span>
          </div>
        </div>
